...
for t in range(num_steps):
    ...
    clear = time_step.reward['clear'] / py_env._clear_reward
    ...
    action, log_prob, scores = p_model.predict((board, pieces), return_scores=True, greedy=True)
