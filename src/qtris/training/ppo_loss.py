"""Clipped-PPO math: surrogate loss term + clipped value loss.

The functions are element-wise / reduced-scalar primitives; callers handle
masking and reduction themselves.
"""
