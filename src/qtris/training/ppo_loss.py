...
Used by both PPO trainers (`training/{ar,_1v1}.py`). The functions are
element-wise / reduced-scalar primitives - callers handle masking and
sequence-vs-scalar reduction themselves (`_1v1.train_step` applies a
per-token decision_mask before reducing).
"""
